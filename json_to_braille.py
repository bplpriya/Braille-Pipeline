...
# Paths
input_json_path = 'ocr_output.json'
output_json_path = 'braille_output.json'
...
braille_table = 'en-us-g2.ctb'  # Use Hindi table if needed: hi-in-g1.ctb (if available)
...
print(f"✅ Braille translation saved to {output_json_path}")
